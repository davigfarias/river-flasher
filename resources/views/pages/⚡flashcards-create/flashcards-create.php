...
use App\Actions\{CreateCard, GetDeckGroupsByLanguage, GetDeckLanguage, GetRecentCards, StoreCardImage};
...
new #[Layout('layouts::app')] #[Title('Criar cartão')] class extends Component
{
    ...
    /**
     * Decks grouped by language, for the deck-select's optgroups — a deck
